...
# The DC-motors are controlled with an IC on the Pi-Hat,
# In order to control this IC, do:
#
#
...
if __name__ == '__main__':
    try:
        speed_set = 40
        setup()
        motor_left(1, left_forward, speed_set)
        time.sleep(3)
        print("Stopping")
        motor_left(0, left_forward, speed_set)
        time.sleep(1)
        print("Going forwards")
        motor_left(1, left_backward, speed_set)
        time.sleep(3)
        motorStop()
        destroy()
