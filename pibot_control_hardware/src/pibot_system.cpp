...
#include "pibot_control_hardware/pibot_system.hpp"
...
hardware_interface::return_type PiBotSystemHardware::configure(
  const hardware_interface::HardwareInfo & info)
{
  ...
  for (const hardware_interface::ComponentInfo & joint : info_.joints) {
    // PiBotSystem has exactly two states and one command interface on each joint
...
PiBotSystemHardware::export_state_interfaces()
{
...
PiBotSystemHardware::export_command_interfaces()
{
...
hardware_interface::return_type PiBotSystemHardware::start()
{
  RCLCPP_INFO(
    rclcpp::get_logger("PiBotSystemHardware"),
...
hardware_interface::return_type PiBotSystemHardware::stop()
{
  RCLCPP_INFO(
    rclcpp::get_logger("PiBotSystemHardware"),
...
hardware_interface::return_type PiBotSystemHardware::read()
{
  RCLCPP_INFO(
    rclcpp::get_logger("PiBotSystemHardware"),
    "Reading...");
...
hardware_interface::return_type pibot_control_hardware::PiBotSystemHardware::write()
{
  RCLCPP_INFO(
    rclcpp::get_logger("PiBotSystemHardware"),
    "Writing...");
...
PLUGINLIB_EXPORT_CLASS(
  pibot_control_hardware::PiBotSystemHardware,
